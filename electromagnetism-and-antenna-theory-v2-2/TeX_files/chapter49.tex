...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{\pathtoparttwo/graphics/diagram1}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtoparttwo/graphics/diagram2}
...
\includegraphics[width=.8\linewidth]{\pathtoparttwo/graphics/diagram3a}
\caption{Radiation pattern of the E-plane.}
\label{fig:thetaplane}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.8\linewidth}
\includegraphics[width=.8\linewidth]{"\pathtoparttwo/graphics/3D view radiation pattern"}
...
\includegraphics[width=0.8\linewidth]{\pathtoparttwo/graphics/3dplotdipole}
\caption{3D view of the radiation pattern with plane at $\theta=\frac{\pi}{2}$}
\label{fig:3dplotdipole}
\end{subfigure}
\begin{subfigure}[b]{1\linewidth}
\includegraphics[width=0.8\linewidth]{\pathtoparttwo/graphics/hplane}
