...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{\pathtoparttwo/graphics/411}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{\pathtoparttwo/graphics/lecture-image-21.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtoparttwo/graphics/lecture2-image-a.png}
