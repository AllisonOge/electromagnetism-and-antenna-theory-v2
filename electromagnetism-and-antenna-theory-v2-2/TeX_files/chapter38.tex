...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{\pathtoparttwo/graphics/lec38fig1}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.7\linewidth]{\pathtoparttwo/graphics/lec38fig2}
...
Therefore, by substituting the above equations into Equation~\eqref{eqn:electricwave} we can then write the general equation for the component $E_{z}$. However, for no backward wave, $C_6 = 0$  so that $Z(z) = C_5e^{-j\beta z}$. Thus the general solution for the wave equation $E_z = XYZ$ is
\begin{equation*}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{\pathtoparttwo/graphics/lec38fig3}
