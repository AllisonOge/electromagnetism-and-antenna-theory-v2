...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/image58_1"}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/image58_2"}
\caption{}
\label{fig:fig 55_2}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/fig 55_3"}
...
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/fig 55_4a"}
\caption{Circle diagram for $d=\dfrac{\lambda}{2}$.}
\label{fig:fig-55_4a}
\end{minipage}
\hfill
\begin{minipage}[b]{0.4\textwidth}
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/fig 55_4b"}
\caption{Circle diagram for $d=\dfrac{\lambda}{2}$.}
\label{fig:fig-55_4a}
\end{minipage}
\end{figure}
...
\begin{figure}[h]
 \centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/image58_3"}
\caption{}
\label{fig:fig}
\end{figure}
\begin{enumerate}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/fig 55_5"}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/image58_4"}
\label{fig:fig-55_6}
\end{figure}
\end{enumerate}
