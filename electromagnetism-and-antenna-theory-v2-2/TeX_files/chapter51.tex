...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtoparttwo/graphics/maximum null"}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtoparttwo/graphics/sinc function1"}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/fig 10 new"}
\label{figure10}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{"\pathtoparttwo/graphics/fig 11 new"}
\label{figure11}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtoparttwo/graphics/fig 12 new"}
\label{figure12}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtoparttwo/graphics/fig 16 lec 47"}
\label{figure16}
\end{figure}
