...
\begin{figure}[h]
\includegraphics[width=1\linewidth]{\pathtoparttwo/graphics/fig1_1}
\centering
\caption{}
\label{fig:1}
\end{figure}\newline
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{\pathtoparttwo/graphics/fig1_2}
\caption{}
\vspace{-20pt}
\label{fig:1}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtoparttwo/graphics/fig1_3}
\caption{}
\label{fig:1}
\end{figure}
